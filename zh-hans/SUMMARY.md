...
* [多控关联](./resource/MultiControl.md#多控关联)
  ...
  - [更新多控组](./resource/MultiControl.md#更新多控组)
  - [启用或禁用多控组](./resource/MultiControl.md#启用或禁用多控组)
  - [查询支持多控的设备列表](./resource/MultiControl.md#查询支持多控的设备列表)
  - [获取附属设备的关联详情](./resource/MultiControl.md#获取附属设备的关联详情)
 ...
 * [蓝牙 Mesh (SIG)](./resource/SIGMesh.md#蓝牙-mesh-sig)
    ...
    - [设备](./resource/SIGMesh.md#设备)
    - [群组](./resource/SIGMesh.md#群组)
    - [控制](./resource/SIGMesh.md#控制)
    - [固件升级](./resource/SIGMesh.md#固件升级)
 * [蓝牙 Mesh (涂鸦)](./resource/Mesh.md#蓝牙-mesh-涂鸦)
    - [准备](./resource/Mesh.md#准备) 
    - [部分基础概念](./resource/Mesh.md#部分基础概念)
    - [管理](./resource/Mesh.md#管理)
    - [配网](./resource/Mesh.md#配网)
    - [设备](./resource/Mesh.md#设备)
    - [群组](./resource/Mesh.md#群组)
    - [控制](./resource/Mesh.md#控制)
...
* [垂直品类 SDK](./resource/ExtensionAbout.md)
  * [IPC SDK](./resource/Camera.md)
    ...
    * [设备配网](./resource/ipc/activitor.md)
    * [摄像机功能](./resource/ipc/live.md)
      * [视频直播](./resource/ipc/live.md#视频直播)
      * [存储卡回放](./resource/ipc/playback.md)
      * [音视频功能](./resource/ipc/av_function.md)
    * [云存储](./resource/ipc/cloud_video.md)
      * [流程图](./resource/ipc/cloud_video.md#流程图)
      * [服务购买](./resource/ipc/cloud_video.md#服务购买)
      * [云视频](./resource/ipc/cloud_video.md#云视频)
    * [设备功能点](./resource/ipc/device_points.md)
      * [功能点常量](./resource/ipc/device_points.md#功能点常量)
      * [低功耗门铃](./resource/ipc/lowpower.md)
      * [存储卡管理](./resource/ipc/sd_card.md)
      * [云台控制](./resource/ipc/ptz.md)
    ...
    * [更新日志](./resource/ipc/version_record.md)
